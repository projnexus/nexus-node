...
export const getInfraction = async (client: Client, infractionId: string): Promise<{ response: Response; status: number }> => {
...
export const deleteInfraction = async (client: Client, infractionId: string): Promise<{ response: Response; status: number }> => {
